...
public class pnlList extends javax.swing.JPanel {
    ...
    private void txtSearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyPressed
        ...
        if(!searchKeyInput.equals("") && evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            loadInfo(1);
            lblHeading.setText(String.format(ConstantHelper.CUSTOMER_LIST_SEARCH_HEADING, searchKey));
            lblHeading.setToolTipText(String.format(ConstantHelper.CUSTOMER_LIST_SEARCH_HEADING, searchKey));
...
private void getTotalPage() {
        try {
            if (searchKey == null)
                totalPage = customerService.countAll() / 10+1;
            else totalPage = customerService.countAllByName(searchKey) / 10+1;
        } catch (SQLException ex) {
            Logger.getLogger(pnlList.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
